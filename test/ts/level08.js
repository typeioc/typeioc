...
(function (Level8) {
    ...
    function registerModuleContainerUsage(test) {
    ...
    Level8.registerModuleContainerUsage = registerModuleContainerUsage;
    function registerModuleForInstanceEmptyParams(test) {
    ...
    Level8.registerModuleForInstanceEmptyParams = registerModuleForInstanceEmptyParams;
