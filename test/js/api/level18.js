...
exports.api = {
    level18: {
        ...
        asValue: {
            ...
            resolves_as_depandency_for_asType: (test) => {
            ...
            resolves_as_dependency_for_asSelf: (test) => {
            ...
            resolves_as_dynamic_dependency: (test) => {
            ...
            resolves_as_dynamic_dependency_named: (test) => {
