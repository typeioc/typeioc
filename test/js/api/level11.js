...
exports.api = {
    ...
    level11: (function () {
        ...
        var CallInfoType = ScaffoldAddons.Types.CallInfoType;
        ...
        function resolve(subject, substitutes) {
            ...
            containerBuilder.register(register).as(function() {
                return interceptor.intercept(subject, substitutes);
            });
        ...
        return {
            setUp: function (callback) {
                ...
                containerBuilder = ScaffoldAddons.createBuilder();
