    ...
    level19: {
        ...
        decorators: {
            ...
            resolve_byvalue_function: (test) => {
                ...
                const container = decorator.build();
                const actual = container.resolve(TestDataDecorators.Resolve.ByValue.test11);
        ...
        interceptors: {
            ...
            instance_method_recieves_original_object: (test) => {
                ...
                const math = interceptor.intercept(Math, [{
                    ...
                    wrapper: (callInfo) => 
                        callInfo.next(
                            callInfo.source.round(callInfo.source.PI) +
                            callInfo.args[0] +
                            callInfo.args[1])
                }, {
                    method: 'pow',
            ...
            instance_field_recieves_original_object: (test) => {
                ...
                test.strictEqual(math.PI,  (Math.PI + PI) * 2);
                math.PI = 7;
