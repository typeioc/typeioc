...
var Decorator = (function () {
    ...
    Decorator.prototype.defineWrapStrategies = function () {
        ...
        result[4 /* FullProperty */] = function (strategyInfo) {
            var getter = strategyInfo.substitute.type === 5 /* Any */ || strategyInfo.substitute.type === 4 /* GetterSetter */ || strategyInfo.substitute.type === 2 /* Getter */ || strategyInfo.substitute.type === 6 /* Field */ ? self.defineWrapGetter(strategyInfo) : self.defineGetter(strategyInfo);
            var setter = strategyInfo.substitute.type === 5 /* Any */ || strategyInfo.substitute.type === 4 /* GetterSetter */ || strategyInfo.substitute.type === 3 /* Setter */ || strategyInfo.substitute.type === 6 /* Field */ ? self.defineWrapSetter(strategyInfo) : self.defineSetter(strategyInfo);
            Object.defineProperty(strategyInfo.destination, strategyInfo.name, {
                get: getter,
                set: setter,
                configurable: true,
    ...
    Decorator.prototype.defineGetter = function (strategyInfo) {
        var self = this;
        return function () {
            return strategyInfo.contextName ? this[strategyInfo.contextName][strategyInfo.name] : strategyInfo.source[strategyInfo.name];
        };
    };
