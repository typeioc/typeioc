...
function isDisposable(value) {
    return typeof value.dispose === 'function' || typeof value.Dispose === 'function';
}
exports.isDisposable = isDisposable;

function getDisposeMethod(value) {
    return typeof value.dispose === 'function' ? value.dispose : (typeof value.Dispose === 'function' ? value.Dispose : null);
}
