...
class RegistrationStorage {
    constructor(storageService) {
        ...
        this._addStrategy[2 /* factoryType */] = this.addForTypeFactory.bind(this);
        this._addStrategy[1 /* factory */] = this.addForFactory.bind(this);
        this._addStrategy[3 /* factoryValue */] = this.addForValueFactory.bind(this);
