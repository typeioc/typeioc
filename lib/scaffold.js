...
const configRegistration_1 = require("./registration/config/configRegistration");
...
class Scaffold {
    ...
    builderService() {
        return {
            create: (internalContainerService) => {
                ...
                return new builder_1.ContainerBuilder(configRegoService, baseRegoService, instanceRegoService, moduleRegoService, internalContainerService, containerService);
            }
        };
    }
    ...
    configRegistrationService(registrationBaseService, moduleRegistrationService) {
        return {
            create: () => new configRegistration_1.ConfigRegistration(registrationBaseService, moduleRegistrationService)
        };
    }
    containerApiService() {
        return {
