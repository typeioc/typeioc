...
const invoker_1 = require("./build/invoker");
class Scaffold {
    createBuilder() {
    ...
    internalContainerService() {
        ...
        return {
            create() {
                ...
                return new internalContainer_1.InternalContainer(regoStorageService, disposableStorageService, baseRegoService, containerApiService, invokerService, this.resolutionDetails);
            }
        };
    }
    invokerService() {
        return {
            create(container, resolutionDetails) {
                return new invoker_1.Invoker(container, resolutionDetails);
            }
        };
    }
