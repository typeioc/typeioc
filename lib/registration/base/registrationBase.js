    ...
    get registrationType() {
        if (!this._registrationType) {
            if (!!this._factoryType && !this._factory && !this._factoryValue) {
                this._registrationType = 2 /* factoryType */;
            }
            else if (!this._factoryType && !!this._factory && !this._factoryValue) {
                this._registrationType = 1 /* factory */;
            }
            else if (!this._factoryType && !this._factory && !!this._factoryValue) {
                this._registrationType = 3 /* factoryValue */;
            }
            else {
