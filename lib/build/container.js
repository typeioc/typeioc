...
var Container = (function () {
    function Container(_registrationStorageService, _disposableStorageService, _registrationBaseService, _containerApiService, container) {
        ...
        this._container = container || new InternalContainer(_registrationStorageService, _disposableStorageService, _registrationBaseService, _containerApiService);
    }
    Container.prototype.add = function (registrations) {
        this._container.add(registrations);
    };
    Container.prototype.createChild = function () {
        return new Container(this._registrationStorageService, this._disposableStorageService, this._registrationBaseService, this._containerApiService, this._container.createChild());
    };
...
function flattenArgs(args, tailArgs) {
