...
var InternalContainer = (function () {
    ...
    InternalContainer.prototype.createDependenciesRegistration = function (api) {
        ...
        var items = api.dependenciesValue.map(function (dependency) {
            ...
            var throwOnError = dependency.required !== false && api.throwResolveError === true;
            return {
        ...
        return items.map(function (item) {
            var baseRegistration = item.dependency.required === false ? _this.createRegistration(item.dependency.service) : item.implementation.cloneFor(_this);
